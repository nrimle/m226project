                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <a id="connection_button" class="button theme left"
                                   href="test.php?<?php echo htmlentities(http_build_query(['from' => $from, 'to' => $to, 'date' => $date, 'time' => $time, 'page' => $page]), ENT_QUOTES, 'UTF-8'); ?>">Earlier
                                    <u id="connection_text">connections</u></a>
                            </div>
                            <div class="col-xs-6 text-right">
                                <a id="connection_button" class="button theme right"
                                   href="test.php?<?php echo htmlentities(http_build_query(['from' => $from, 'to' => $to, 'date' => $date, 'time' => $time, 'page' => $page + 2]), ENT_QUOTES, 'UTF-8'); ?>">Later
                                    <u id="connection_text">connections</u></a>
                            </div>
                        </div>
